...
8. Require byte-identical repeated static and shared library builds in the
   maintained Linux production-dependency environment; this is reproducibility
   evidence for that environment, not a cross-toolchain identity promise.
